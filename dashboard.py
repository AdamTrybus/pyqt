...
class DashboardWidget(QWidget):
    ...
    def edit_event_dialog(self, event):
        ...
        date_edit = QDateEdit(QDate.fromString(event['date'], Qt.ISODate), dialog)
        ...
        save_button.clicked.connect(lambda: self.handle_save_button_click(dialog, event, title_edit.text(), description_edit.text(), date_edit.date().toString("yyyy-MM-dd"), time_edit.time().toString("hh:mm")))
